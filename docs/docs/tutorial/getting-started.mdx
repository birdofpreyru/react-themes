...
```jsx title="/src/components/BasicExample/index.jsx"
...
<CodeBlock
  ...
  title="src/components/BasicExample/default.scss"
...
<CodeBlock
  className="language-jsx"
  title="src/components/Example01.jsx"
...
<CodeBlock
  className="language-jsx"
  title="src/components/Example02.jsx"
...
And we update the example using [`<ThemeProvider>`](/docs/api/components#ThemeProvider) component from React Themes.
All `<BasicExample>` component instances anywhere within this [`<ThemeProvider>`](/docs/api/components#ThemeProvider)
...
<CodeBlock
  className="language-jsx"
  title="src/components/Example03.jsx"
...
<CodeBlock
  className="language-jsx"
  title="src/components/Example04/index.jsx"
